const language = {
   ...
   msg32: "Вы можете улучшить свой уникальный музыкальный вкус, используя приведенные ниже команды. Включите и слушайте нужную музыку. Поддерживаются все музыкальные платформы.",
   msg33: "Бот-Команды",
